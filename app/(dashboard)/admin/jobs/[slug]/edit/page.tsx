          ...
          <CardContent className="grid gap-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="tags" placeholder="engineering, remote, startup" {...register('tags')} />
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 items-center">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="isFeatured" className="mb-0">Featured Job</Label>
              </div>
              <div className="flex items-center space-x-2">
                <input id="isUrgent" type="checkbox" {...register('isUrgent')} className="h-4 w-4" />
                <Label htmlFor="isUrgent" className="mb-0">Urgent Hiring</Label>
              </div>
            </div>
