      ...
      <div className="container relative mx-auto px-4 py-14 sm:py-16">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          ...
          <Link
            ...
            style={{ backgroundImage: `url('/Warehouse%20Jobs%20in%20UAE%202026.png')` }}
          >
            <div className="absolute inset-0 -z-10 bg-gradient-to-b from-white/70 via-white/80 to-white/90" />
            <div className="relative z-10 flex items-center justify-between gap-3">
              <span className="rounded-full bg-[#0f766e] px-3 py-1 text-sm font-medium text-white">Featured</span>
              <span className="text-sm font-medium text-white">Read article</span>
            </div>
            <h2 className="mt-5 text-2xl font-semibold text-white transition">
              Warehouse Jobs in UAE 2026
            </h2>
            <p className="mt-4 text-base leading-7 text-white/90">
              Discover warehouse and logistics jobs across Dubai, Abu Dhabi, and the UAE with salary ranges, company hiring insights, requirements, and application tips.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              {['Warehouse Jobs', 'Logistics Careers', 'DP World', 'DHL Jobs'].map((keyword) => (
                <span key={keyword} className="rounded-full border border-white/30 bg-white/10 px-3 py-1 text-sm text-white/90">
                  {keyword}
                </span>
              ))}
