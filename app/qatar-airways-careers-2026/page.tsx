            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="rounded-xl sm:rounded-2xl lg:rounded-[2rem] border border-slate-200 bg-white p-5 sm:p-6 lg:p-8 shadow-sm lg:hidden" id="related-careers-mobile">
                ...
                <div className="mt-5 sm:mt-6 space-y-4">
                  {relatedJobs.map((job) => (
                    <Link key={job.title} href={job.href} className="group flex flex-col rounded-2xl sm:rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-4 sm:p-5 shadow-sm transition hover:-translate-y-1 hover:border-[#5C0E62] hover:shadow-lg">
                      <div className="flex items-start justify-between gap-3">
                        <h3 className="text-sm sm:text-base font-semibold text-slate-900">{job.title}</h3>
                        <span className="rounded-full bg-[#5C0E62]/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#5C0E62]">Read</span>
                      </div>
                      <p className="mt-2 text-xs sm:text-sm text-slate-600 line-clamp-2">{job.description}</p>
                      <span className="mt-3 inline-flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-700 transition group-hover:text-[#5C0E62]">
                        Explore job page
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded-2xl lg:rounded-[2rem] border border-slate-200 bg-white p-6 lg:p-8 shadow-sm">
                ...
                <div className="mt-5 lg:mt-6 space-y-4">
                  {relatedJobs.map((job) => (
                    <Link key={job.title} href={job.href} className="group flex flex-col rounded-2xl lg:rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-4 lg:p-5 shadow-sm transition hover:-translate-y-1 hover:border-[#5C0E62] hover:shadow-lg">
                      <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="mt-3 inline-flex items-center gap-2 text-xs lg:text-sm font-semibold text-slate-700 transition group-hover:text-[#5C0E62]">
                        Explore job page
                        <span className="transition group-hover:translate-x-1">→</span>
                      </span>
                    </Link>
